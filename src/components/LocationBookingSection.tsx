...
export const LocationBookingSection: React.FC<LocationBookingSectionProps> = ({
  ...
  const [formData, setFormData] = useState({
    ...
    checkOut: '',
    guests: '2',
    roomType: 'غرف ديلوكس مطلة على البحر / Deluxe Seaview Room',
    notes: '',
  });
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-10 sm:mb-14">
          <span className="inline-block text-[#D94E28] font-['Cairo'] font-bold text-xs sm:text-sm tracking-wider uppercase bg-[#FFF1ED] border border-[#FFDDD3] px-3.5 py-1 rounded-full mb-2.5">
            {lang === 'ar' ? 'الموقع وخطوات الحجز' : 'Location & Booking Policy'}
          </span>
          ...
          <div className="lg:col-span-7 flex flex-col justify-between space-y-6">
            ...
            <div className="p-6 sm:p-7 rounded-3xl bg-white border border-[#E2E8F0] shadow-sm">
              <div className="flex items-center justify-between mb-4">
                ...
                {onOpenBooking && (
                  ...
                  >
                    ...
                    <span>{lang === 'ar' ? 'احجز أونلاين' : 'Book Online'}</span>
                  </button>
                )}
              </div>
              ...
              <div className="flex items-start gap-3.5 p-4 rounded-2xl bg-[#F8FAFC] border border-[#E2E8F0] mb-3">
                ...
                <div>
                  <h4 className="font-['Cairo'] font-bold text-sm sm:text-base text-[#0F223D]">
                    {bookingStep1 || t.step1Title}
                  </h4>
                  <p className="font-['Tajawal'] text-xs text-[#64748B] mt-0.5">
                    {lang === 'ar'
                      ? 'إرسال طلب الحجز وتحديد التواريخ، ليتم حجز الغرفة ومراجعة الإتاحة فوراً.'
                      : 'Submit reservation request with dates to lock room availability instantly.'}
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3.5 p-4 rounded-2xl bg-[#FFF7ED] border border-[#FFEDD5]">
                ...
                <div>
                  <h4 className="font-['Cairo'] font-bold text-sm sm:text-base text-[#0F223D]">
                    {bookingStep2 || t.step2Title}
                  </h4>
                  <p className="font-['Tajawal'] text-xs text-[#7C2D12] mt-0.5">
                    {lang === 'ar'
                      ? 'تحويل عربون الحجز عبر تطبيق إنستاباي (InstaPay) لتثبيت الحجز وإرسال تأكيد رسمي.'
                      : 'Transfer deposit via InstaPay to confirm reservation and receive instant voucher.'}
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="p-5 rounded-2xl bg-white border border-[#E2E8F0] flex flex-wrap items-center justify-between gap-3 shadow-xs">
              <span className="font-['Cairo'] font-bold text-sm text-[#0F223D]">
                {lang === 'ar' ? 'تابع حساباتنا الرسمية:' : 'Follow our official channels:'}
              </span>
            ...
            <div className="p-6 sm:p-7 rounded-3xl bg-white border border-[#E2E8F0] shadow-md h-full flex flex-col justify-between">
              <div>
                <div className="flex items-center justify-between mb-4">
                  ...
                  <span className="text-[11px] font-['Cairo'] text-[#0F223D] font-bold bg-[#F1F5F9] border border-[#CBD5E1] px-2.5 py-1 rounded-full">
                    {lang === 'ar' ? 'استفسار سريع' : 'Fast Inquiry'}
                  </span>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-3.5">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div>
                      ...
                      >
                        ...
                        <option value="5+">5+ أفراد (مجموعة)</option>
                      </select>
                    </div>
                    ...
                    <div>
                      ...
                      >
                        <option value="غرف ديلوكس مطلة على البحر">غرف ديلوكس (بحر)</option>
                        <option value="أكواخ مميزة على الشاطئ">أكواخ مميزة (شاطئ)</option>
                        <option value="أكواخ عادية تقليدية">أكواخ عادية</option>
                        <option value="باقة خاصة أو رحلات">باقة أو رحلة خارجية</option>
                      </select>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      placeholder={
                        lang === 'ar'
                          ? 'هل تحتاج انتقالات من محافظتك؟ أو أي متطلبات خاصة...'
                          : 'Need transportation or special diet?'
                      }
              ...
              {formSubmitted && (
                <div className="mt-3 p-3 rounded-xl bg-[#E8F5E9] text-[#2E7D32] text-xs font-['Cairo'] font-bold flex items-center gap-2">
                  ...
                  <span>
                    {lang === 'ar'
                      ? 'تم فتح تطبيق واتساب بإرسال بياناتك!'
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h4 className="font-['Cairo'] font-bold text-base text-[#0F223D]">
                  {lang === 'ar' ? 'موقع دروب كامب — رأس شيطان' : 'Droub Camp Location — Ras Shitan'}
                </h4>
                <p className="font-['Tajawal'] text-xs text-[#64748B]">
                  طريق طابا - نويبع، شاطئ رأس شيطان، جنوب سيناء، مصر
                </p>
              </div>
            </div>
