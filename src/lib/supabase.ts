...
export const DEFAULT_ROOM_PRICING: RoomPricing[] = [
  {
    room_type: 'غرف ديلوكس مطلة على البحر',
    single_price: 1800,
    double_price: 2400,
    triple_price: 3000,
  ...
  {
    room_type: 'أكواخ مميزة على الشاطئ',
    single_price: 1300,
    double_price: 1800,
    triple_price: 2300,
...
export const DEFAULT_PACKAGES: PackageItem[] = [
  {
    title: 'باقة الهروب إلى سيناء (3 ليالٍ / 4 أيام)',
  ...
  {
    title: 'باقة المغامرة والوديان - 4 ليالٍ',
...
export const DEFAULT_TRIPS: TripItem[] = [
  {
    title: 'رحلة وادي الوشواش والبحيرة العذبة',
  ...
  {
    title: 'رحلة الكانيون الملون والكانيون الأبيض',
  ...
  {
    title: 'رحلة طابا وقلعة صلاح الدين',
